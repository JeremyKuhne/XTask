...
namespace XTask.Systems.File
{
    ...
    public interface IExtendedFileService
    {
        ...
        ///  To return all DOS aliases, pass <see langword="null"/>. This list usually has several hundred
        ///  aliases.
        /// </summary>
        /// <remarks>
        ///  <para>
        ...
        /// </summary>
        IEnumerable<AlternateStreamInformation> GetAlternateStreamInformation(string path);
